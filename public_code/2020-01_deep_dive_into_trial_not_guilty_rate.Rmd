...
The DATA Lab's data story based off of the [DAO Data Dashboard](https://data.philadao.com). The goal is to look at how single trials that account for a large number of individual cases impact the trial conviction rate. The code here corresponds to the three line charts in the story showing the trial conviction rate for aggravated assault with a gun cases between 2014 and 2019, and the hypothetical scenarios in which two large cases didn't exist, or if witnesses had appeared at trial and the case ended with a guilty verdict.
